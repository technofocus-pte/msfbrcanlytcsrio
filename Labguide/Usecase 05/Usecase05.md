...
1. Open your browser, navigate to the address bar, and type or paste the following URL: +++https://app.fabric.microsoft.com/+++ then press the **Enter** button.
    ...
    >[!Note] If you are directed to Microsoft Fabric Home page, then skip to step \#5.
...
1. If PowerBI opens by default , please folllow the below steps , other wise skip this step
    ...
    ![](https://raw.githubusercontent.com/technofocus-pte/msfbrcanlytcsrio/refs/heads/Cloud-slice/Labguide/Usecase%2005/media/image5.png)


1. Fabric home page, select **+New workspace** tile.

    ![](https://raw.githubusercontent.com/technofocus-pte/msfbrcanlytcsrio/refs/heads/Cloud-slice/Labguide/Usecase%2005/media/image6.png)
...
1. In the **Create a workspace tab, enter** the following details and click on the **Apply** button.
    ...
    ![](https://raw.githubusercontent.com/technofocus-pte/msfbrcanlytcsrio/refs/heads/Cloud-slice/Labguide/Usecase%2005/media/image7.png)

    ![](https://raw.githubusercontent.com/technofocus-pte/msfbrcanlytcsrio/refs/heads/Cloud-slice/Labguide/Usecase%2005/media/image8.png)

    ![](https://raw.githubusercontent.com/technofocus-pte/msfbrcanlytcsrio/refs/heads/Cloud-slice/Labguide/Usecase%2005/media/image9.png)
...
1. In the **Fabric** page, select **+ New item** to create a lakehouse and select **Warehouse**
    ...
    ![A screenshot of a computer Description automatically generated](https://raw.githubusercontent.com/technofocus-pte/msfbrcanlytcsrio/refs/heads/Cloud-slice/Labguide/Usecase%2005/media/image11.png)

1. On the **New warehouse** dialog, enter +++WideWorldImporters+++ and click on the **Create** button.

    ![](https://raw.githubusercontent.com/technofocus-pte/msfbrcanlytcsrio/refs/heads/Cloud-slice/Labguide/Usecase%2005/media/image12.png)

1. When provisioning is complete, the **WideWorldImporters** warehouse landing page appears.

    ![](https://raw.githubusercontent.com/technofocus-pte/msfbrcanlytcsrio/refs/heads/Cloud-slice/Labguide/Usecase%2005/media/image13.png)
...
1. From the **WideWorldImporters** warehouse landing page, select **Warehouse_FabricXX** in the left-sided navigation menu to return to the workspace item list.
    ...
    ![](https://raw.githubusercontent.com/technofocus-pte/msfbrcanlytcsrio/refs/heads/Cloud-slice/Labguide/Usecase%2005/media/image14.png)

1. In the **Warehouse_FabricXX** page, select +**New item**. Then, click **Copy job** to view the full list of available items under Get data.
...
1. In the **New copy job** window, in the **Name** box, enter +++Load Customer Data+++. Select **Create**

    ![](https://raw.githubusercontent.com/technofocus-pte/msfbrcanlytcsrio/refs/heads/Cloud-slice/Labguide/Usecase%2005/media/image16.png)

1. Provisioning is complete when the **Copy job** page opens.

    ![](https://raw.githubusercontent.com/technofocus-pte/msfbrcanlytcsrio/refs/heads/Cloud-slice/Labguide/Usecase%2005/media/image17.png)

1. On the first page of the **Copy job** window, select **Sample data** from the menu bar on this page. For this tutorial, we use the **Retail Data Model from Wide World Importers** sample. Select this option to navigate to the next page

    ![](https://raw.githubusercontent.com/technofocus-pte/msfbrcanlytcsrio/refs/heads/Cloud-slice/Labguide/Usecase%2005/media/image18.png)
...
1. The Choose data destination page allows you to configure the type of item. In the OneLake catalog, select your **Wide World Importers** warehouse, and select **Next.**

    ![](https://raw.githubusercontent.com/technofocus-pte/msfbrcanlytcsrio/refs/heads/Cloud-slice/Labguide/Usecase%2005/media/image20.png)

1. The **Choose copy job mode** page select **Full copy** and select **Next**.
...
1. Enter the following destination tables, and then select **Next**.
...
1. When complete, the **Copy job** will deliver a **Succeeded** notification and status. You'll now see six new tables from the Wide World Importers dataset in your warehouse.
    ...
    ![](https://raw.githubusercontent.com/technofocus-pte/msfbrcanlytcsrio/refs/heads/Cloud-slice/Labguide/Usecase%2005/media/image25.png)
...
1. In the **WideWorldImporters** warehouse, expand **Schemas \> dbo \> Tables** and verify that the tables (**dimension_city**, **dimension_customer**, **dimension_date**, **dimension_employee**, **dimension_stock_item**, and **fact_sale**) have been created successfully.
...
1. To execute the query, on the query designer ribbon, select **Run**.
    ...
    ![](https://raw.githubusercontent.com/technofocus-pte/msfbrcanlytcsrio/refs/heads/Cloud-slice/Labguide/Usecase%2005/media/image30.png)

    ![](https://raw.githubusercontent.com/technofocus-pte/msfbrcanlytcsrio/refs/heads/Cloud-slice/Labguide/Usecase%2005/media/image31.png)
...
1. In the query editor, paste the following code. The CURRENT_TIMESTAMP T-SQL function returns the current UTC timestamp as a **datetime**. Select **Run** to execute the query.
    ...
    ![](https://raw.githubusercontent.com/technofocus-pte/msfbrcanlytcsrio/refs/heads/Cloud-slice/Labguide/Usecase%2005/media/image32.png)

1. To create a table clone as of a *past point in time*, in the query editor, paste the following code **to replace the existing statements**. The code creates a clone of the dimension_city table and the fact_sale table at a certain point in time. Run the query.
    ...
    ![](https://raw.githubusercontent.com/technofocus-pte/msfbrcanlytcsrio/refs/heads/Cloud-slice/Labguide/Usecase%2005/media/image33.png)
...
1. In the query editor, paste the following code. The code creates a schema and then creates clones of the **fact_sale** and **dimension_city** tables in the new schema. Run the query.
...
1. When execution completes, preview the data loaded into the **dimension_city1** table in the **dbo1** schema.
    ...
    ![](https://raw.githubusercontent.com/technofocus-pte/msfbrcanlytcsrio/refs/heads/Cloud-slice/Labguide/Usecase%2005/media/image39.png)

1. To create table clones as of a *previous point in time*, in the query editor, paste the following code **to replace the existing statements**. The code creates a clone of the **dimension_city** table and the **fact_sale** table at certain points in time in the new schema. Run the query.
    ...
    ![](https://raw.githubusercontent.com/technofocus-pte/msfbrcanlytcsrio/refs/heads/Cloud-slice/Labguide/Usecase%2005/media/image40.png)
...
1. To execute the query, on the query designer ribbon, select **Run**
    ...
    ![](https://raw.githubusercontent.com/technofocus-pte/msfbrcanlytcsrio/refs/heads/Cloud-slice/Labguide/Usecase%2005/media/image46.png)

1. When execution completes, rename the query as `Create Aggregate Procedure`.

    ![A screenshot of a computer Description automatically generated](https://raw.githubusercontent.com/technofocus-pte/msfbrcanlytcsrio/refs/heads/Cloud-slice/Labguide/Usecase%2005/media/image47.png)
...
1. In the query editor, paste the following code. The code executes the **populate_aggregate_sale_by_city** stored procedure. Run the query.
...
1. When execution completes, rename the query as +++Run Aggregate Procedure+++.
    ...
    ![](https://raw.githubusercontent.com/technofocus-pte/msfbrcanlytcsrio/refs/heads/Cloud-slice/Labguide/Usecase%2005/media/image53.png)

1. To preview the aggregated data, in the **Explorer** pane, select the **aggregate_sale_by_date_city** table.

    ![](https://raw.githubusercontent.com/technofocus-pte/msfbrcanlytcsrio/refs/heads/Cloud-slice/Labguide/Usecase%2005/media/image54.png)

    >[!Note] If the table doesn't appear, select the ellipsis (...) for the **Tables** folder, and then select **Refresh**.
...
1. In the query editor, paste the following code. The code creates a view named Top10Customers. The view uses a query to retrieve the top 10 customers based on sales. Select **Run** to execute the query.
...
1. Create another new query, similar to Step 1. From the **Home** tab of the ribbon, select **New SQL query**.
    ...
    ![](https://raw.githubusercontent.com/technofocus-pte/msfbrcanlytcsrio/refs/heads/Cloud-slice/Labguide/Usecase%2005/media/image60.png)
...
1. Copy the timestamp value returned to your clipboard.
    ...
    ![](https://raw.githubusercontent.com/technofocus-pte/msfbrcanlytcsrio/refs/heads/Cloud-slice/Labguide/Usecase%2005/media/image62.png)
...
1. When execution completes, rename the query as +++Time Travel+++.
    ...
    ![](https://raw.githubusercontent.com/technofocus-pte/msfbrcanlytcsrio/refs/heads/Cloud-slice/Labguide/Usecase%2005/media/image63.png)
...
1. Remove the trailing zeroes, for example: **2026-07-27T06:20:55.823**.

1. To retrieve the top 10 customers *as of now*, in a new query editor, paste the following statement. The code retrieves the top 10 customers by using the FOR TIMESTAMP AS OF query hint.

1. Replace YOUR_TIMESTAMP with the timestamp you copied to the clipboard.
...
1. Rename the query as +++Time Travel Now+++
    ...
    ![](https://raw.githubusercontent.com/technofocus-pte/msfbrcanlytcsrio/refs/heads/Cloud-slice/Labguide/Usecase%2005/media/image66.png)
...
1. Notice that the second top **CustomerKey value** is **49** for Tailspin Toys (Muir, MI).

    ![](https://raw.githubusercontent.com/technofocus-pte/msfbrcanlytcsrio/refs/heads/Cloud-slice/Labguide/Usecase%2005/media/image68.png)

1. Modify the timestamp value to an earlier time *by **subtracting one minute*** from the timestamp
...
1. From the **Explorer** pane, from the dbo schema **Tables** folder, drag the **fact_sale** table to the visual query canvas.
    ...
    ![](https://raw.githubusercontent.com/technofocus-pte/msfbrcanlytcsrio/refs/heads/Cloud-slice/Labguide/Usecase%2005/media/image70.png)
...
1. In the **Keep top rows** dialog box, enter +++10000+++ and Select **OK**.
    ...
    ![](https://raw.githubusercontent.com/technofocus-pte/msfbrcanlytcsrio/refs/heads/Cloud-slice/Labguide/Usecase%2005/media/image72.png)
...
1. Right-click on **dimension_city** and select **Insert into canvas**
    ...
    ![](https://raw.githubusercontent.com/technofocus-pte/msfbrcanlytcsrio/refs/heads/Cloud-slice/Labguide/Usecase%2005/media/image74.png)

    ![](https://raw.githubusercontent.com/technofocus-pte/msfbrcanlytcsrio/refs/heads/Cloud-slice/Labguide/Usecase%2005/media/image75.png)
...
1. From the transformations ribbon, select the dropdown beside **Combine** and select **Merge queries as new** as shown in the below image.
    ...
    ![](https://raw.githubusercontent.com/technofocus-pte/msfbrcanlytcsrio/refs/heads/Cloud-slice/Labguide/Usecase%2005/media/image76.png)
...
1. With the **Merge** step selected, select the **Expand** button beside **fact_sale** on the header of the data grid as shown in the below image, then select the columns **TaxAmount, Profit, TotalIncludingTax** and select **Ok.**
    ...
    ![](https://raw.githubusercontent.com/technofocus-pte/msfbrcanlytcsrio/refs/heads/Cloud-slice/Labguide/Usecase%2005/media/image81.png)
...
1. On the **Group by** settings page, enter the following details.
    ...
    1. **City**
        ...
        - In the **New column
    name,** enter +++SumOfTaxAmount+++ in **Operation** column field, select **Sum**, then under **Column** field, select **TaxAmount.** Click on **Add aggregation** to add more aggregate column and operation.

        - In the **New column
    name,** enter +++SumOfProfit+++ in **Operation** column field, select **Sum**, then under **Column** field, select **Profit**. Click on **Add aggregation** to add more aggregate column and operation.

        - In the **New column name**,
    enter +++SumOfTotalIncludingTax+++ in **Operation** column field, select **Sum**, then under **Column** field, **TotalIncludingTax.**

        - Click on the **OK** button

    ![](https://raw.githubusercontent.com/technofocus-pte/msfbrcanlytcsrio/refs/heads/Cloud-slice/Labguide/Usecase%2005/media/image83.png)

    ![](https://raw.githubusercontent.com/technofocus-pte/msfbrcanlytcsrio/refs/heads/Cloud-slice/Labguide/Usecase%2005/media/image84.png)
...
1. Click on the **Refresh** icon below the **Home** tab.
    ...
    ![A screenshot of a computer Description automatically generated](https://raw.githubusercontent.com/technofocus-pte/msfbrcanlytcsrio/refs/heads/Cloud-slice/Labguide/Usecase%2005/media/image87.png)
...
1. On the **Home** ribbon, open the **New SQL query** dropdown list, and then select **New SQL query in notebook**
    ...
    ![](https://raw.githubusercontent.com/technofocus-pte/msfbrcanlytcsrio/refs/heads/Cloud-slice/Labguide/Usecase%2005/media/image88.png)
...
1. From the left menu, select **Warehouse_Fabric65897@lab.LabInstance.Id** workspace icon and then select workspace name.

    ![](https://raw.githubusercontent.com/technofocus-pte/msfbrcanlytcsrio/refs/heads/Cloud-slice/Labguide/Usecase%2005/media/image92.png)
...
1. From the list, in the **Store data** section, select the **Lakehouse** item type.
    ...
    ![](https://raw.githubusercontent.com/technofocus-pte/msfbrcanlytcsrio/refs/heads/Cloud-slice/Labguide/Usecase%2005/media/image93.png)

1. When provisioning is complete, the lakehouse enter +++Shortcut_Exercise+++ as the lakehouse name and unselect the lakehouses schemas. Select **Create**.
...
1. In the **Select a data source type** window, select the **Wide World Importers **warehouse, and then select **Next**.
...
1. In the **OneLake object** browser, expand **Tables**, expand the **dbo **schema, and then select the checkbox for the **dimension_customer** table. Select **Next**.
...
1. On the **dimension_customer** table page, click **Analyze data with**, select **Notebook**, and then choose **New notebook** to create a new Spark notebook for data analysis
...
1. On the **Home** ribbon, select the **Run all** button.
    ...
    ![](https://raw.githubusercontent.com/technofocus-pte/msfbrcanlytcsrio/refs/heads/Cloud-slice/Labguide/Usecase%2005/media/image106.png)
...
1. From **Notebook2** page, navigate and click on **WideWorldImporters** Workspace on the left-sided navigation menu.
...
1. In the **Explorer** pane, select **+ Warehouses**.
    ...
    ![](https://raw.githubusercontent.com/technofocus-pte/msfbrcanlytcsrio/refs/heads/Cloud-slice/Labguide/Usecase%2005/media/image109.png)

1. In the **OneLake catalog** window, select the **Shortcut_Exercise** SQL analytics endpoint. Select **Confirm**.
...
1. In the **Explorer** pane, notice that the **Shortcut_Exercise** SQL analytics endpoint is available.
    ...
    ![](https://raw.githubusercontent.com/technofocus-pte/msfbrcanlytcsrio/refs/heads/Cloud-slice/Labguide/Usecase%2005/media/image111.png)
...
>[!Note] A cross-database query uses three-part naming of *database.schema.table* to reference objects.

1. From the **Home** tab of the ribbon, select **New SQL query**.

    ![](https://raw.githubusercontent.com/technofocus-pte/msfbrcanlytcsrio/refs/heads/Cloud-slice/Labguide/Usecase%2005/media/image112.png)
...
1. **Run** the query, and review the query result.
    ...
    ![](https://raw.githubusercontent.com/technofocus-pte/msfbrcanlytcsrio/refs/heads/Cloud-slice/Labguide/Usecase%2005/media/image113.png)

    ![](https://raw.githubusercontent.com/technofocus-pte/msfbrcanlytcsrio/refs/heads/Cloud-slice/Labguide/Usecase%2005/media/image114.png)
...
1. Rename the query for reference. Right-click on **SQL query** in the **Explorer** and select **Rename**.
    ...
    ![](https://raw.githubusercontent.com/technofocus-pte/msfbrcanlytcsrio/refs/heads/Cloud-slice/Labguide/Usecase%2005/media/image116.png)

1. In the **Rename** dialog box, under the **Name** field, enter +++Cross-warehouse query+++, then click on the **Rename** button.

    ![](https://raw.githubusercontent.com/technofocus-pte/msfbrcanlytcsrio/refs/heads/Cloud-slice/Labguide/Usecase%2005/media/image117.png)
...
1. In the **WideWorldImportes** page, under the **Home** tab, select the **New semantic model**.
    ...
    ![](https://raw.githubusercontent.com/technofocus-pte/msfbrcanlytcsrio/refs/heads/Cloud-slice/Labguide/Usecase%2005/media/image118.png)
...
1. Expand the dbo schema, expand the **Tables** folder, and then check the **dimension_city** and **fact_sale** tables. Select **Confirm**.
    ...
    ![](https://raw.githubusercontent.com/technofocus-pte/msfbrcanlytcsrio/refs/heads/Cloud-slice/Labguide/Usecase%2005/media/image119.png)

1. From the left navigation select *+++Warehouse_Fabric@lab.LabInstance.Id+++*, as shown in the image below

    ![A screenshot of a computer AI-generated content may be incorrect.](https://raw.githubusercontent.com/technofocus-pte/msfbrcanlytcsrio/refs/heads/Cloud-slice/Labguide/Usecase%2005/media/image120.png)

1. To open the semantic model, return to the workspace landing page, and then select the **Sales Model** semantic model.

    ![](https://raw.githubusercontent.com/technofocus-pte/msfbrcanlytcsrio/refs/heads/Cloud-slice/Labguide/Usecase%2005/media/image121.png)

    ![](https://raw.githubusercontent.com/technofocus-pte/msfbrcanlytcsrio/refs/heads/Cloud-slice/Labguide/Usecase%2005/media/image122.png)
...
1. In the **Manage relationship** window, select **+ New relationship**.
    ...
    ![](https://raw.githubusercontent.com/technofocus-pte/msfbrcanlytcsrio/refs/heads/Cloud-slice/Labguide/Usecase%2005/media/image125.png)
...
1. In the **Manage relationship** window, select **Close**.
    ...
    ![A screenshot of a computer AI-generated content may be incorrect.](https://raw.githubusercontent.com/technofocus-pte/msfbrcanlytcsrio/refs/heads/Cloud-slice/Labguide/Usecase%2005/media/image128.png)
...
1. In the report designer, complete the following steps to create a column chart visual:
    ...
    ![](https://raw.githubusercontent.com/technofocus-pte/msfbrcanlytcsrio/refs/heads/Cloud-slice/Labguide/Usecase%2005/media/image131.png)


1. In the **Visualizations** pane, select the **Azure Map** visual.

    ![](https://raw.githubusercontent.com/technofocus-pte/msfbrcanlytcsrio/refs/heads/Cloud-slice/Labguide/Usecase%2005/media/image132.png)
...
1. In the **Visualizations** pane, select the **Table** visual.
    ...
    ![A screenshot of a computer AI-generated content may be incorrect.](https://raw.githubusercontent.com/technofocus-pte/msfbrcanlytcsrio/refs/heads/Cloud-slice/Labguide/Usecase%2005/media/image134.png)
...
1. Verify that the completed design of the report page resembles the following image.
    ...
    ![A screenshot of a computer AI-generated content may be incorrect.](https://raw.githubusercontent.com/technofocus-pte/msfbrcanlytcsrio/refs/heads/Cloud-slice/Labguide/Usecase%2005/media/image137.png)

1. To save the report, on the **Home** ribbon, select **File** \> **Save**.

    ![A screenshot of a computer AI-generated content may be incorrect.](https://raw.githubusercontent.com/technofocus-pte/msfbrcanlytcsrio/refs/heads/Cloud-slice/Labguide/Usecase%2005/media/image138.png)
...
1. In the Save your report window, in the Enter a name for your report box, enter +++Sales Analysis+++ and Select **Save**
    ...
    ![A screenshot of a computer AI-generated content may be incorrect.](https://raw.githubusercontent.com/technofocus-pte/msfbrcanlytcsrio/refs/heads/Cloud-slice/Labguide/Usecase%2005/media/image141.png)
...
1. In the menu of the workspace header, select **Workspace settings**.
    ...
    ![A screenshot of a computer AI-generated content may be incorrect.](https://raw.githubusercontent.com/technofocus-pte/msfbrcanlytcsrio/refs/heads/Cloud-slice/Labguide/Usecase%2005/media/image143.png)
...
1. In the **Delete workspace?** dialog box, click on the **Delete** button.
    ...
    ![](https://raw.githubusercontent.com/technofocus-pte/msfbrcanlytcsrio/refs/heads/Cloud-slice/Labguide/Usecase%2005/media/image145.png)
